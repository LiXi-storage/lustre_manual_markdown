...
- the section called “ Recovery Overview”
- the section called “Metadata Replay”
- the section called “Reply Reconstruction”
- the section called “Version-based Recovery”
- the section called “Commit on Share”
- the section called “Imperative Recovery”
...
In the case of failed recovery, a client is evicted by the server and must reconnect after having flushed its saved state related to that server, as described in *the section called “Client Eviction”*, above. Failed recovery might occur for a number of reasons, including:
...
The Version-based Recovery (VBR) feature improves Lustre file system reliability in cases where client requests (RPCs) fail to replay during recovery [2].
...
- Each inode[2] stores a version, that is, the number of the last transaction (transno) in which the inode was changed.
