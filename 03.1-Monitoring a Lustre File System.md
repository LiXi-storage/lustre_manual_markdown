...
Event types marked with * are not recorded by default. Refer to [the section called “Setting the Changelog Mask”](dbdoclet.modifyChangelogMask.html) for instructions on modifying the Changelogs mask.
