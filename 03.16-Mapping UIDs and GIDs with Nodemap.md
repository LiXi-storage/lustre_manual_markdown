...
- the section called “Setting a Mapping”
- the section called “Altering Properties”
- the section called “Enabling the Feature”
- the section called “default Nodemap”
- the section called “Verifying Settings”
- the section called “Ensuring Consistency”
...
If UID 11002 or GID 11001 do not exist on the Lustre MDS or MGS, create them in LDAP or other data sources, or trust clients by setting `identity_upcall` to `NONE`. For more information, see [the section called “User/Group Upcall”](dbdoclet.identity_upcall.html).
