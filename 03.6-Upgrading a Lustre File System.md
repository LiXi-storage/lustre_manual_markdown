...
5. Download the Lustre server RPMs for your platform from the [Lustre Releases](https://wiki.whamcloud.com/display/PUB/Lustre+Releases) repository. See Table 5, “Packages Installed on Lustre Servers”for a list of required packages.
...
7. Download the Lustre client RPMs for your platform from the [Lustre Releases](https://wiki.whamcloud.com/display/PUB/Lustre+Releases) repository. See Table 6, “Packages Installed on Lustre Clients” for a list of required packages.
...
2. Download the Lustre server RPMs for your platform from the [Lustre Releases](https://wiki.whamcloud.com/display/PUB/Lustre+Releases) repository. See Table 5, “Packages Installed on Lustre Servers” for a list of required packages.
...
6. Download the Lustre client RPMs for your platform from the [Lustre Releases](https://wiki.whamcloud.com/display/PUB/Lustre+Releases) repository. See Table 6, “Packages Installed on Lustre Clients” for a list of required packages.
